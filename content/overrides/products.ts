...
const hi = (text: string, roman: string): DesiName => ({
  script: "deva",
  text,
  roman,
  lang: "hi",
...
export const overrides: Record<string, ProductOverride> = {
  ...
  jamun_powder: {
    ...
    form: "powder",
    colourWorld: world("#3f1a36", "#6b2f5b", "light", [
      "#3f1a36",
      "#7a3b6e",
      "#b06aa3",
      "#f6f1e4",
    ...
    seo: {
      ...
      keywords: [
        "jamun powder",
        "java plum powder",
        "syzygium cumini powder",
        "jamun powder exporter india",
      ],
    },
  },
  apple_powder: {
    ...
    desiName: hi("सेब", "Seb"),
    form: "powder",
    colourWorld: world("#e9d9a6", "#c9b877", "dark", [
      "#e9d9a6",
      "#d4b35a",
      "#b8862f",
      "#f6f1e4",
  ...
  pineapple_powder: {
    ...
    form: "powder",
    colourWorld: world("#f1c40f", "#c99a06", "dark", [
      "#f1c40f",
      "#f5d64a",
      "#b8862f",
      "#f6f1e4",
    ...
    seo: {
      ...
      description:
        "Bright pineapple fruit powder for beverages, confectionery and dairy. Indian origin, export-documented, COA on request.",
      keywords: [
        "pineapple powder",
        "pineapple fruit powder",
        "pineapple powder exporter india",
      ],
    },
  },
  raw_mango_powder: {
    ...
    form: "powder",
    colourWorld: world("#b9c85a", "#8ea03a", "dark", [
      "#b9c85a",
      "#d6e07c",
      "#6f8a2a",
      "#f6f1e4",
    ...
    seo: {
      ...
      description:
        "Amchur — sun-dried green mango powder — the natural souring agent for spice blends and seasonings. Indian origin, export-documented.",
      keywords: [
        "amchur",
        "raw mango powder",
        "dried mango powder",
        "amchur exporter india",
      ],
    },
  },
  guava_powder: {
    ...
    form: "powder",
    colourWorld: world("#f2b6a0", "#d98d74", "dark", [
      "#f2b6a0",
      "#e8927a",
      "#c9634a",
      "#f6f1e4",
    ...
    seo: {
      ...
      description:
        "Pink guava powder rich in vitamin C and pectin fibre for beverages and nutraceuticals. Indian origin, export-documented.",
      keywords: [
        "guava powder",
        "guava fruit powder",
        "pink guava powder india",
      ],
    },
  },
  mulberry_powder: {
    ...
    form: "powder",
    colourWorld: world("#5b2a6f", "#7e4494", "light", [
      "#5b2a6f",
      "#8f57a6",
      "#c58ad6",
      "#f6f1e4",
    ...
    seo: {
      ...
      description:
        "Deep-purple mulberry fruit powder with anthocyanins for functional beverages and wellness blends. Indian origin, export-documented.",
      keywords: [
        "mulberry powder",
        "mulberry fruit powder",
        "mulberry powder exporter india",
      ],
    },
  },
  orange_powder: {
    ...
    form: "powder",
    colourWorld: world("#f28c28", "#c96d12", "dark", [
      "#f28c28",
      "#ffb25a",
      "#b8862f",
      "#f6f1e4",
    ...
    seo: {
      ...
      description:
        "Orange fruit powder with citrus flavonoids for beverages and bakery. Indian origin, export-documented.",
      keywords: [
        "orange powder",
        "orange fruit powder",
        "orange powder supplier india",
      ],
    },
  },
  lemon_powder: {
    ...
    form: "powder",
    colourWorld: world("#f4e04d", "#d1bd23", "dark", [
      "#f4e04d",
      "#f9ec8a",
      "#b8a51f",
      "#f6f1e4",
    ...
    seo: {
      ...
      description:
        "Lemon fruit powder for beverages, seasonings and confectionery. Indian origin, export-documented.",
      keywords: [
        "lemon powder",
        "lemon fruit powder",
        "lemon powder exporter india",
      ],
    },
  },
  ...
  beetroot_powder: {
    ...
    form: "powder",
    colourWorld: world("#a5133f", "#7b0d2e", "light", [
      "#a5133f",
      "#d1275b",
      "#f06b8a",
      "#f6f1e4",
    ...
    seo: {
      ...
      description:
        "Deep-red beetroot powder with dietary nitrates and betalains for health drinks, supplements and natural colour. Indian origin, export-documented.",
      keywords: [
        "beetroot powder",
        "beet root powder",
  ...
  spinach_powder: {
    ...
    form: "powder",
    colourWorld: world("#2f6b3a", "#1f4a28", "light", [
      "#2f6b3a",
      "#4f9a55",
      "#8fd08a",
      "#f6f1e4",
    ...
    seo: {
      ...
      description:
        "Dark-green spinach powder for pasta, snacks and nutraceutical blends. Indian origin, export-documented.",
      keywords: [
        "spinach powder",
        "dehydrated spinach powder",
        "spinach powder exporter india",
      ],
    },
  },
  tomato_powder: {
    ...
    form: "powder",
    colourWorld: world("#c4341f", "#9a2717", "light", [
      "#d33f2b",
      "#f0664f",
      "#ffa07a",
      "#f6f1e4",
    ...
    seo: {
      ...
      description:
        "Deep-red tomato powder with lycopene and umami for soups, sauces and seasonings. Indian origin, export-documented.",
      keywords: [
        "tomato powder",
        "dehydrated tomato powder",
        "tomato powder exporter india",
      ],
    },
  },
  ginger_powder: {
    ...
    form: "powder",
    colourWorld: world("#d9b98c", "#b8945f", "dark", [
      "#d9b98c",
      "#e8d2ad",
      "#b8862f",
      "#f6f1e4",
    ...
    seo: {
      ...
      description:
        "Ground dry ginger (sonth) with gingerol-driven warmth for spice blends, beverages and bakery. Indian origin, export-documented.",
      keywords: [
        "ginger powder",
        "dry ginger powder",
        "sonth powder",
  ...
  turmeric_powder: {
    ...
    form: "powder",
    colourWorld: world("#e0a106", "#b47f04", "dark", [
      "#e0a106",
      "#f5c542",
      "#c4740a",
      "#f6f1e4",
    ...
    seo: {
      ...
      description:
        "Golden turmeric powder from established Indian curcumin belts — Erode, Sangli, Nizamabad, Lakadong. Export-documented, COA on request.",
      keywords: [
        "turmeric powder",
        "haldi powder",
  ...
  sea_buckthorn_powder: {
    ...
    form: "powder",
    colourWorld: world("#f28a1c", "#c46a0e", "dark", [
      "#f28a1c",
      "#ffb04a",
      "#b8862f",
      "#f6f1e4",
    ...
    seo: {
      ...
      description:
        "Himalayan sea buckthorn powder rich in omega fatty acids, flavonoids and vitamin C for nutraceuticals and cosmetics. Indian origin, export-documented.",
      keywords: [
  ...
  dehydrated_onion_powder: {
    ...
    form: "powder",
    colourWorld: world("#efe3c8", "#cdbf9c", "dark", [
      "#efe3c8",
      "#d9c79b",
      "#b8862f",
      "#8a6a3a",
    ...
    seo: {
      ...
      description:
        "Creamy-white dehydrated onion powder from the Mahuva belt of Gujarat — a world-scale dehydration origin. Export-documented, COA on request.",
      keywords: [
  ...
  dehydrated_onion_flakes: {
    ...
    form: "flakes",
    colourWorld: world("#e6cfa4", "#c4aa78", "dark", [
      "#e6cfa4",
      "#f0dcb8",
      "#b8862f",
      "#8a6a3a",
    ...
    specs: [
      {
        label: "Appearance",
        value: "Flakes / kibbled (chopped, minced, granules on request)",
      },
      {
        label: "Color",
        value: "Creamish white (white onion) / pink (red onion)",
      },
    ...
    seo: {
      ...
      description:
        "Dehydrated onion flakes, kibbled, chopped and granules from the Mahuva belt, Gujarat. Export-documented, COA on request.",
      keywords: [
        "dehydrated onion flakes",
        "kibbled onion",
        "onion flakes exporter india",
      ],
    },
  },
  garlic_powder: {
    ...
    form: "powder",
    colourWorld: world("#efe8d6", "#d0c7ad", "dark", [
      "#efe8d6",
      "#e0d6bd",
      "#b8862f",
      "#8a6a3a",
    ...
    seo: {
      ...
      description:
        "Off-white dehydrated garlic powder with stable sulfur compounds for food processing and seasonings. Indian origin, export-documented.",
  ...
  dehydrated_garlic_flakes: {
    ...
    form: "flakes",
    colourWorld: world("#e8dfc6", "#c7bc9c", "dark", [
      "#e8dfc6",
      "#f3ecd8",
      "#b8862f",
      "#8a6a3a",
    ...
    specs: [
      {
        label: "Appearance",
        value: "Flakes (chopped, minced, granules on request)",
      },
    ...
    seo: {
      ...
      description:
        "Dehydrated garlic flakes, chopped and granules for seasonings and sauces. Indian origin, export-documented.",
  ...
  fried_onion: {
    ...
    form: "fried",
    colourWorld: world("#c9862b", "#9c6318", "dark", [
      "#c9862b",
      "#e2a24a",
      "#7a4a10",
      "#f6f1e4",
    ...
    specs: [
      ...
      {
        label: "Frying medium",
        value: "Refined vegetable oil (declared per lot)",
      },
    ...
    seo: {
      ...
      description:
        "Golden crispy fried onion — birista — for biryani kits, toppings and ready meals. Indian origin, export-documented.",
      keywords: [
        "fried onion",
        "crispy onion",
        "birista",
        "fried onion exporter india",
      ],
    },
  },
  ...
  dry_red_chilli: {
    ...
    form: "whole",
    colourWorld: world("#b72a1b", "#8a1d12", "light", [
      "#b72a1b",
      "#e0452f",
      "#ff8a6a",
      "#f6f1e4",
    ...
    seo: {
      ...
      description:
        "Whole dried red chillies quoted by variety, ASTA colour and SHU: Guntur, Byadgi, Teja, Kashmiri. Export-documented, COA on request.",
      keywords: [
        "dry red chilli",
  ...
  chilli_powder: {
    ...
    form: "powder",
    colourWorld: world("#d1391f", "#a22a15", "light", [
      "#d1391f",
      "#ef5a3c",
      "#ff9b7a",
      "#f6f1e4",
    ...
    seo: {
      ...
      description:
        "Ground red chilli milled to your ASTA colour and SHU brief from Guntur and Byadgi chillies. Export-documented, COA on request.",
      keywords: [
        "red chilli powder",
  ...
  turmeric_finger: {
    ...
    form: "whole",
    colourWorld: world("#c98a12", "#9c690a", "dark", [
      "#c98a12",
      "#e8ad2e",
      "#f5d67a",
      "#f6f1e4",
    ...
    seo: {
      ...
      description:
        "Dried turmeric fingers and bulbs from Erode, Sangli, Nizamabad and Lakadong, quoted on curcumin grade. Export-documented, COA on request.",
      keywords: [
        "turmeric finger",
        "dried turmeric bulb",
        "lakadong turmeric",
        "turmeric finger exporter india",
      ],
    },
  },
  cumin_seed: {
    ...
    form: "whole",
    colourWorld: world("#8b6b3a", "#6a4f28", "light", [
      "#8b6b3a",
      "#b08d55",
      "#d9bd8a",
      "#f6f1e4",
    ...
    seo: {
      ...
      description:
        "Whole cumin seeds from Gujarat and Rajasthan, the world’s dominant origin, quoted on purity and volatile oil. Export-documented, COA on request.",
      keywords: [
        "cumin seeds",
        "jeera",
        "cumin seed exporter india",
        "gujarat cumin",
      ],
    },
  },
  coriander_seed: {
    ...
    form: "whole",
    colourWorld: world("#a8923f", "#7f6d2b", "dark", [
      "#a8923f",
      "#c9b45f",
      "#e6d894",
      "#f6f1e4",
    ...
    seo: {
      ...
      description:
        "Whole coriander seeds with linalool-rich aroma from Rajasthan, Madhya Pradesh and Gujarat. Export-documented, COA on request.",
  ...
  moringa_leaf_powder: {
    ...
    form: "powder",
    colourWorld: world("#476f28", "#325018", "light", [
      "#476f28",
      "#74a94a",
      "#a9d48a",
      "#f6f1e4",
    ...
    seo: {
      ...
      description:
        "Green moringa leaf powder — protein, vitamins, iron and calcium in one leaf. Indian origin, export-documented, COA on request.",
      keywords: [
        "moringa leaf powder",
  ...
  basmati_1121: {
    ...
    form: "grain",
    colourWorld: world("#e9dfc4", "#c9bd9a", "dark", [
      "#e9dfc4",
      "#f5efdc",
      "#b8862f",
      "#8a6a3a",
    ...
    seo: {
      ...
      description:
        "Extra-long 1121 basmati in white sella, golden sella and steam variants. Export-documented, quoted per grade.",
      keywords: [
        "1121 basmati rice",
        "1121 sella rice",
        "1121 golden sella",
  ...
  basmati_1509: {
    ...
    desiName: hi("बासमती", "Basmati"),
    form: "grain",
    colourWorld: world("#e3d6b5", "#c2b48f", "dark", [
      "#e3d6b5",
      "#efe6cf",
      "#b8862f",
      "#8a6a3a",
    ...
    seo: {
      ...
      description:
        "Long-grain 1509 basmati in white sella, golden sella and steam variants. Export-documented, quoted per grade.",
      keywords: [
        "1509 basmati rice",
        "1509 sella rice",
        "basmati rice exporter india",
