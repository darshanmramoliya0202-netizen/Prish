...
export const INDIA_PLACES: {
  ...
  {
    match: /lakadong|meghalaya/i,
    name: "Lakadong, Meghalaya",
    coords: [92.2, 25.5],
  },
  ...
  {
    match: /lahaul|spiti/i,
    name: "Lahaul–Spiti, Himachal",
    coords: [77.4, 32.5],
  },
  ...
  {
    match: /prayagraj|allahabad/i,
    name: "Prayagraj, Uttar Pradesh",
    coords: [81.85, 25.44],
  },
  {
    match: /western uttar pradesh/i,
