            ...
            <div>
              ...
              <ul className="mt-3 flex flex-wrap gap-2">
                {r.compliance.docsUsuallyAsked.map((d) => (
                  <li
                    key={d}
                    className="rounded-full border border-current/20 px-3 py-1 text-small"
                  >
                    {d}
                  </li>
                ))}
              ...
              <p className="mt-6 text-small opacity-70">
                Incoterm we usually quote for {r.short}:{" "}
                <strong>{r.incotermDefault}</strong>. FOB and CIF both
                available.
              </p>
            </div>
          </div>
