...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 hidden h-14 w-14 items-center justify-center rounded-full shadow-[0_8px_30px_rgba(37,211,102,0.45)] transition duration-300 hover:scale-110 hover:shadow-[0_12px_36px_rgba(37,211,102,0.6)] md:flex"
