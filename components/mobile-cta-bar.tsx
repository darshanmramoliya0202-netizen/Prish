...
export default function MobileCTABar() {
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 flex items-center justify-between border-t border-white/10 bg-leaf-dark px-4 py-3 md:hidden">
      <a
        href="https://wa.me/919586616746"
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center gap-2 rounded-full px-4 py-2 text-sm font-semibold text-white transition active:opacity-80"
      ...
      <a
        href="/inquiry"
        className="rounded-full bg-gold-warm px-4 py-2 text-sm font-semibold text-leaf-dark transition active:opacity-80"
      >
        Get quote
      </a>
    </div>
