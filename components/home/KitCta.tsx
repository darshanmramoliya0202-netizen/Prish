  ...
  return (
    ...
    >
      <div className="container-x text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lead opacity-85">{home.kitSub}</p>
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
          <ButtonLink href="/inquiry" size="lg" className="!bg-ink-900 !text-cream-50 hover:!bg-forest-950">
            {cta.kit} <IconArrow />
          </ButtonLink>
          <ButtonLink href={waLink()} size="lg" variant="whatsapp" data-umami-event="whatsapp_click" data-umami-event-placement="kit_cta">
