...
import { orderedClusters, productsByCluster, clusterPath, home } from "@/content";
              ...
              <li key={c.id} data-reveal>
                <Link href={clusterPath(c)} className="group grid items-center gap-6 py-8 md:grid-cols-12 md:py-10">
                  ...
                  <div className="md:col-span-6">
                    <h3 className="font-display text-display-md group-hover:underline decoration-gold-500 underline-offset-8">{c.name}</h3>
